class UI {
    ...
    <div class="row">
      <div class="col-md-3">
       <img src="${user.avatar_url}" class="img-fluid img-thumbnail mb-2" >
       <a href="${user.html_url}"target="_blank" class="btn btn-primary btn-block mb-3">View Profile</a>
      </div>

      <div class="col-md-9">
        <span class="badge badge-info badge-bg">Public Repos:${user.public_repos}</span>
        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">Website and Blog:${user.blog}</li>
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      <span class="badge badge-info badge-bg">Stars:${repo.stargazers_count}</span>
